...
public abstract class BaseTransformer
    ...
    void transform(Context context,
        ...
        log " * ClassPool initialized with ${inputClassNames.size()} input classes"
        // and ${referencedClassNames.size()} reference classes"

        def allCtClasses = inputClassNames
                .collect { classPool.getCtClass(it) }

        weaver.before(allCtClasses)

        for (className in allCtClasses) {
